...
const brands = ["Almaty", "TALGAR ZAVOD", "KrasnyZavod"];

const manufacturers = ["Almty", "Nursultan", "Kyrgyz"];
            ...
            <div className="row mb-3">
              <div className="col-lg-3 d-none d-lg-block">
                ...
                >
                  ...
                  <option value="1">Krasny</option>
                  <option value="2">obychny</option>
                  <option value="3">Penoblock</option>
                </select>
              </div>
